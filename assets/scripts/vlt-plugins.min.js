!(function (t) {
                ...
                ((n = t.extend({}, n)),
                  ...
                  o.on('click.' + e, n.linkElement, function (e) {
                    ...
                    2 === e.which ||
                      e.metaKey ||
                      e.shiftKey ||
                      (-1 !== navigator.platform.toUpperCase().indexOf('WIN') && e.ctrlKey)
      ...
      animationCheck: function (i, n, s) {
        ...
        return (
          l || c
            ...
            : n && s
              ? (i = r.inClass)
              : !n && s ? (i = r.inDuration) : n && !s ? (i = r.outClass) : n || s || (i = r.outDuration),
          i
        );
      },
      in: function () {
  ...
  (function (t, e) {
    'object' == typeof exports && 'undefined' != typeof module
      ? (module.exports = e())
      : 'function' == typeof define && define.amd ? define(e) : ((t = t || self).cssVars = e());
  })(this, function () {
    'use strict';
    function t() {
      return (t =
    ...
    function i(t) {
      function e() {
        return !(
          '<' === (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : '').trim().charAt(0)
        );
      }
      function i(t, e) {
        a.onError(t, r[e], e);
        ...
        if (
          ...
          o.open('GET', t),
            ...
            (o.onreadystatechange = function () {
              4 === o.readyState &&
                (200 === o.status && e(o.responseText) ? n(o.responseText, s) : i(o, s));
            }),
            o.send();
        }
      });
      ...
      if (l >= 0 && c > 0) {
        for (n = [], a = i.length; d >= 0 && !o;)
          d == l
            ...
            : 1 == n.length
              ? (o = [n.pop(), c])
              : ((s = n.pop()) < a && ((a = s), (r = c)), (c = i.indexOf(e, d + 1))),
            (d = l < c && l >= 0 ? l : c);
        n.length && (o = [a, r]);
      }
      return o;
              ...
              if (i.preserveVars || !r || 0 !== r.indexOf(w)) {
                if (-1 !== o.indexOf(x + '(')) {
                  ...
                  l !== s.value &&
                    ((l = h(l)),
                      i.preserveVars
                        ? (t.splice(n, 0, { type: a, property: r, value: l }), n++)
                        : (s.value = l));
                }
              } else t.splice(n, 1), n--;
          }
        ...
        if ((!1 === o.watch && P && (P.disconnect(), (P = null)), !o.__benchmark)) {
          ...
          if (
            ((o.__benchmark = g()),
              ...
              !P &&
              (Array.apply(null, o.rootElement.querySelectorAll('[data-cssvars="out"]')).forEach(function (
                t
              ) {
                var e = t.getAttribute('data-cssvars-group');
                (e
                  ? o.rootElement.querySelector(
                    '[data-cssvars="src"][data-cssvars-group="'.concat(e, '"]')
                  )
          ...
          if (T && o.onlyLegacy) {
            ...
            !A && (o.shadowDOM || o.rootElement.shadowRoot || o.rootElement.host)
              ? n({
                ...
                onSuccess: function (t, e, i) {
                  return (
                    (t = ((t = t.replace(_.cssComments, '').replace(_.cssMediaQueries, '')).match(
                      _.cssVarDeclRules
                    ) || [])
                      .join('')) || !1
                  );
    ...
    return (
      (f.reset = function () {
        for (var t in ((k = !1), P && (P.disconnect(), (P = null)), ($ = 0), (L = null), (A = !1), M))
          M[t] = {};
      }),
      f
    );
  ...
  (function () {
    ...
    (t.prototype.needsClick = function (t) {
      ...
      (t.prototype.onTouchMove = function (t) {
        return (
          !this.trackingClick ||
          ((this.targetElement !== this.getTargetElementFromEventTarget(t.target) || this.touchHasMoved(t)) &&
        ...
        if (
          ((this.cancelNextClick = !1),
            ...
            ((c = t.changedTouches[0]),
              (d =
                document.elementFromPoint(c.pageX - window.pageXOffset, c.pageY - window.pageYOffset) || d),
          ...
          return t.timeStamp - r > 100 || (n && window.top !== window && 'input' === o)
            ...
            : (this.focus(d),
              this.sendClick(d, t),
              (n && 'select' === o) || ((this.targetElement = null), t.preventDefault()),
              !1);
        return (
          !(!n || s || !(l = d.fastClickScrollParent) || l.fastClickLastScrollTop === l.scrollTop) ||
  ...
  (function (t, e) {
    ...
    function B(t, e) {
      ...
      if (
        ((e._time || (e._initted && !e._dur)) &&
          ((i = D(t.rawTime(), e)),
            (!e._dur || Ze(0, e.totalDuration(), i) - e._tTime > _e) && e.render(i, !0)),
    ...
    function j(t, e, i, n) {
      return (
        xi(t, e),
        t._initted
          ? !i && t._pt && ((t._dur && !1 !== t.vars.lazy) || (!t._dur && t.vars.lazy)) && re !== li.frame
            ? (Ne.push(t), (t._lazy = [e, n]), 1)
            : void 0
          : 1
      );
    }
        ...
        function (t, n, s) {
          ...
          if (!T) {
            ...
            for (
              ...
              (f = g % x - o),
                (m = c - ((g / x) | 0)),
                (T[g] = v = u ? Math.abs('y' === u ? m : f) : $e(f * f + m * m)),
                b < v && (b = v),
                v < y && (y = v);
            'random' === a && W(T),
              (T.max = b - y),
              ...
              (T.v = S =
                (parseFloat(e.amount) ||
                  parseFloat(e.each) *
                  (S < x ? S - 1 : u ? ('y' === u ? S / x : x) : Math.max(x, S / x)) ||
                  0) * ('edges' === a ? -1 : 1)),
              (T.b = S < 0 ? r - S : r),
    ...
    function Q(t, e) {
      ...
      return (
        ...
        o(t) &&
        ((i = r = t.radius || Ee),
          t.values ? ((t = ei(t.values)), (n = !a(t[0])) && (i *= i)) : (t = U(t.increment))),
        q(
          e,
          r
            ? s(t)
              ...
              : function (e) {
                for (
                  ...
                  (s = n ? (s = t[u].x - o) * s + (r = t[u].y - l) * r : Math.abs(t[u] - o)) < c &&
                    ((c = s), (d = u));
    ...
    function Z(t) {
      for (var e, i, n, s, a = 0, r = ''; ~(e = t.indexOf('random(', a));)
        (n = t.indexOf(')', e)),
          (s = '[' === t.charAt(e + 7)),
          (i = t.substr(e + 7, n - e - 7).match(s ? je : Oe)),
          (r += t.substr(a, e - a) + J(s ? i : +i[0], +i[1], +i[2] || 1e-5)),
          (a = n + 1);
      ...
      return (
        ...
        ((n = f[0] / si),
          ...
          d === u
            ? (o = l = 0)
            : ((h = d - u),
              (l = 0.5 < c ? h / (2 - d - u) : h / (d + u)),
              (o = d === n ? (s - r) / h + (s < r ? 6 : 0) : d === s ? (r - n) / h + 2 : (n - s) / h + 4),
              (o *= 60)),
          (f[0] = ~~(o + 0.5)),
          (f[1] = ~~(100 * l + 0.5)),
          (f[2] = ~~(100 * c + 0.5))),
    ...
    function at(t, e, i) {
      ...
      if (
        ((l = l.map(function (t) {
          return (
            (t = nt(t, e, 1)) && c + (e ? t[0] + ',' + t[1] + '%,' + t[2] + '%,' + t[3] : t.join(',')) + ')'
          );
        })),
        ...
        for (r = (s = t.replace(ri, '1').split(De)).length - 1; d < r; d++)
          o +=
            s[d] +
            (~n.indexOf(d) ? l.shift() || c + '0,0,0,0)' : (a.length ? a : l.length ? l : i).shift());
    ...
    function rt(t) {
      ...
      if (((ri.lastIndex = 0), ri.test(i)))
        return (e = oi.test(i)), (t[1] = at(t[1], e)), (t[0] = at(t[0], e, st(t[1]))), !0;
    }
    function ot(t) {
      var e = (t + '').split('('),
        i = di[e[0]];
              ...
              (function (t) {
                for (
                  ...
                  (i = a[o]),
                    ...
                    (n = i.substr(0, e)),
                    (s[r] = isNaN(n) ? n.replace(hi, '').trim() : +n),
                    (r = i.substr(e + 1).trim());
                return s;
              })(e[1])
            ]
    ...
    function lt(t, e, i, n) {
      ...
      return (
        y(t, function (t) {
          for (var e in ((di[t] = He[t] = a), (di[(s = t.toLowerCase())] = i), a))
            di[s + ('easeIn' === e ? '.in' : 'easeOut' === e ? '.out' : '.inOut')] = di[t + '.' + e] = a[e];
        }),
        a
      );
    }
      ...
      if (
        ...
        (c = new Ye[t]()).init(
          ...
          c.rawVars
            ? e[t]
            : (function (t, e, i, a, r) {
              if ((s(t) && (t = Si(t, r, e, i, a)), !o(t) || (t.style && t.nodeType) || ze(t)))
              ...
              for (i in e)
                for (n = a.length; n--;)
                  (s = (s = t._ptLookup[n][i]) && s.d) &&
                    (s._pt && (s = yt(s, i)), s && s.modifier && s.modifier(e[i], t, a[n], i));
            })(t, i);
          };
        }
      };
    ...
    function zt(t, e) {
      var i = Hi.createElementNS
        ? Hi.createElementNS((e || 'http://www.w3.org/1999/xhtml').replace(/^https/, 'http'), t)
        : Hi.createElement(t);
    ...
    function Dt(t) {
      ...
      return (
        n && (s ? n.insertBefore(this, s) : n.appendChild(this)), Vi.removeChild(i), (this.style.cssText = a), e
      );
    }
    function Ft(t, e) {
    ...
    function Bt(t) {
      ...
      return (
        (e && (e.width || e.height)) || t.getBBox === Dt || (e = Dt.call(t, !0)),
        !e || e.width || e.x || e.y
          ? e
          : { x: +Ft(t, ['x', 'cx', 'x1']) || 0, y: +Ft(t, ['y', 'cy', 'y1']) || 0, width: 0, height: 0 }
      );
    }
    function Rt(t) {
    ...
    function Nt(t, e, i, n) {
      ...
      return (
        ...
        pn[e] && 'transform' !== e
          ...
          : ((s = t.style[e]) && 'auto' !== s && !n && !~(s + '').indexOf('calc(')) ||
          (s = (Mn[e] && Mn[e](t, e, i)) || Ot(t, e) || b(t, e) || ('opacity' === e ? 1 : 0)),
    ...
    function qt(t, e, i, n) {
      ...
      if (
        ((b.b = i),
          (b.e = n),
          (i += ''),
          'auto' == (n += '') && ((t.style[e] = n), (n = Ot(t, e) || n), (t.style[e] = i)),
          rt((r = [i, n])),
          (n = r[1]),
          (l = (i = r[0]).match(De) || []),
          (n.match(De) || []).length)
    ...
    function Yt(t) {
      var e = t.split(' '),
        ...
        n = e[1] || '50%';
      return (
        ('top' !== i && 'bottom' !== i && 'left' !== n && 'right' !== n) || ((t = i), (i = n), (n = t)),
        (e[0] = _n[i] || i),
        (e[1] = _n[n] || n),
        e.join(' ')
      );
      ...
      if (e.tween && e.tween._time === e.tween._dur) {
        ...
        if ('all' === o || !0 === o) (r.cssText = ''), (n = 1);
          ...
          for (s = (o = o.split(',')).length; -1 < --s;)
            (i = o[s]), pn[i] && ((n = 1), (i = 'transformOrigin' === i ? Sn : xn)), jt(a, i);
    ...
    function Ut(t, e) {
      ...
      return r.svg && t.getAttribute('transform')
        ? '1,0,0,1,0,0' ===
          (l = [(s = t.transform.baseVal.consolidate().matrix).a, s.b, s.c, s.d, s.e, s.f]).join(',')
          ? kn
          : l
        : (l !== kn ||
          t.offsetParent ||
    ...
    function Qt(t, e, i, n, s, a) {
      ...
      i
        ? d !== kn &&
        (o = m * b - v * g) &&
        ((l = S * (-v / o) + T * (m / o) - (m * w - v * y) / o),
          (S = S * (b / o) + T * (-g / o) + (g * w - b * y) / o),
          (T = l))
        : ((S = (r = Bt(t)).x + (~x[0].indexOf('%') ? S / 100 * r.width : S)),
    ...
    function Kt(t, e, i, s, a, r) {
      ...
      return (
        d &&
        ('short' === (o = a.split('_')[1]) && (h %= c) != h % 180 && (h += h < 0 ? c : -c),
          'cw' === o && h < 0
            ? (h = (h + 36e9) % c - ~~(h / c) * c)
            : 'ccw' === o && 0 < h && (h = (h - 36e9) % c - ~~(h / c) * c)),
    ...
    function Zt(t, e, i) {
      var n,
        ...
        d = Yi.style,
        u = i._gsap;
      for (s in ((d.cssText = getComputedStyle(i).cssText + ';position:absolute;display:block;'),
        (d[xn] = e),
        ...
        (a = u[s]) !== (r = n[s]) &&
          ...
          ((o = Y(a) !== (c = Y(r)) ? Vt(i, s, a, c) : parseFloat(a)),
            (l = parseFloat(r)),
            (t._pt = new Fi(t._pt, u, s, o, l - o, xt)),
            (t._pt.u = c || 0),
            t._props.push(s));
      ...
      gi = (((mi = ft.prototype).delay = function (t) {
        ...
        (mi.totalDuration = function (t) {
          return arguments.length
            ? ((this._dirty = 0),
              H(this, this._repeat < 0 ? t : (t - this._repeat * this._rDelay) / (this._repeat + 1)))
            : this._tDur;
        }),
        (mi.totalTime = function (t, e) {
          ...
          if (i && i.smoothChildTiming && this._ts) {
            for (
              ...
              i.parent._time !==
                i._start + (0 <= i._ts ? i._tTime / i._ts : (i.totalDuration() - i._tTime) / -i._ts) &&
                i.totalTime(i._tTime, !0),
                (i = i.parent);
            !this.parent && this._dp.autoRemoveChildren && R(this._dp, this, this._start - this._delay);
          }
          return (
            (this._tTime !== t || (!this._dur && !e) || (this._initted && Math.abs(this._zTime) === _e)) &&
        ...
        (mi.time = function (t, e) {
          return arguments.length
            ? this.totalTime(Math.min(this.totalDuration(), t + I(this)) % this._dur || (t ? this._dur : 0), e)
            : this._time;
        }),
        ...
        (mi.progress = function (t, e) {
          return arguments.length
            ? this.totalTime(this.duration() * (!this._yoyo || 1 & this.iteration() ? t : 1 - t) + I(this), e)
        ...
        (mi.iteration = function (t, e) {
          ...
          return arguments.length
            ...
            : this._repeat ? Je(this._tTime, i) + 1 : 1;
        }),
              ...
              (t
                ...
                : (ci(),
                  ...
                  this.totalTime(
                    ...
                    1 === this.progress() && (this._tTime -= _e) && Math.abs(this._zTime) !== _e
                  ))),
              this)
            : e;
        }),
        (mi.startTime = function (t) {
          return arguments.length
            ? (this.parent && this.parent._sort && R(this.parent, this, t - this._delay), this)
            : this._start;
        }),
        ...
        (mi.rawTime = function (t) {
          ...
          return e
            ? t && (!this._ts || (this._repeat && this._time && this.totalProgress() < 1))
              ...
              : this._ts ? D(e.rawTime(t), this) : this._tTime
            : this._tTime;
        }),
        ...
        (mi.reversed = function (t) {
          ...
          return arguments.length
            ? (t !== this.reversed() &&
              ((this[null === this._pauseTS ? '_ts' : '_pauseTS'] = Math.abs(e) * (t ? -1 : 1)),
        ...
        (mi.eventCallback = function (t, e, i) {
          ...
          return 1 < arguments.length
            ? (e
              ? ((n[t] = e), i && (n[t + 'Params'] = i), 'onUpdate' === t && (this._onUpdate = e))
              : delete n[t],
              this)
            : n[t];
        }),
        (mi.then = function (t) {
          ...
          return new Promise(function (i) {
            ...
            var a = s(t) ? t : _;
            (e._initted && 1 === e.totalProgress() && 0 <= e._ts) || (!e._tTime && e._ts < 0)
              ? n()
              : (e._prom = n);
          });
        }),
      ...
      return (
        ...
        (o.render = function (t, e, i) {
          ...
          if (b !== this._tTime || i || y) {
                ...
                if (((a = s._prev), (s._act || T <= s._end) && s._ts && c !== s)) {
                  ...
                  if (
                    (s.render(
                      0 < s._ts
                        ? (T - s._start) * s._ts
                        : (s._dirty ? s.totalDuration() : s._tDur) + (T - s._start) * s._ts,
                      e,
                      i
                    ),
                      n !== this._time || (!this._ts && !l))
            ...
            if (c && !e && (this.pause(), (c.render(m <= n ? 0 : -_e)._zTime = m <= n ? 1 : -1), this._ts))
              return (this._start = u), F(this), this.render(t, e, i);
            this._onUpdate && !e && ni(this, 'onUpdate', !0),
              ((b === v && v >= this.totalDuration()) || (!b && this._ts < 0)) &&
              ((u !== this._start && Math.abs(d) === Math.abs(this._ts)) ||
                ((!t && g) || !((t && 0 < this._ts) || (!b && this._ts < 0)) || z(this, 1),
                  e ||
                  (t < 0 && !m) ||
        ...
        (o.getChildren = function (t, e, i, n) {
          ...
          for (var s = [], a = this._first; a;)
            a._start >= n &&
              (a instanceof Ei
                ? e && s.push(a)
                : (i && s.push(a), t && s.push.apply(s, a.getChildren(!0, e, i)))),
              (a = a._next);
          return s;
        }),
        ...
        (o.remove = function (t) {
          return n(t)
            ...
            : s(t)
              ? this.killTweensOf(t)
              : (A(this, t), t === this._recent && (this._recent = this._last), O(this));
        }),
        (o.totalTime = function (e, i) {
          return arguments.length
            ? ((this._forcing = 1),
              ...
              !this._ts ||
              (this._start = w(
                li.time - (0 < this._ts ? e / this._ts : (this.totalDuration() - e) / -this._ts)
              )),
        ...
        (o.getTweensOf = function (t, e) {
          for (var i, n = [], s = ei(t), a = this._first; a;)
            a instanceof Ei
              ? !x(a._targets, s) || (e && !a.isActive('started' === e)) || n.push(a)
    ...
    var yi,
        ...
        var u,
          ...
          f =
            'get' !== i
              ...
              : s(p)
                ? d
                  ? t[e.indexOf('set') || !s(t['get' + e.substr(3)]) ? e : 'get' + e.substr(3)](d)
                  : t[e]()
                : p,
          m = s(p) ? (d ? ki : Mi) : _i;
        if (
          ...
          return isNaN(f + a)
            ...
            : ((u = new Fi(this._pt, t, e, +f || 0, a - (f || 0), 'boolean' == typeof p ? Li : $i, 0, m)),
              d && (u.fp = d),
      ...
      xi = function t(e, i) {
        ...
        if (
          ...
          for (
            n = $(b, Ve),
            m = (u = D[(e._pt = 0)] ? g(D[0]).harness : 0) && b[u.prop],
            S = (O && l(S)) || (S && !O),
            s = 0;
            s < D.length;
            s++
            ...
            if (
              ...
              for (a in n)
                Ye[a] && (h = mt(a, n, e, f, o, B))
                  ? h.priority && (c = 1)
                  : (p[a] = r = wi.call(e, o, a, 'get', n[a], f, B, 0, b.stringFilter));
            e._op && e._op[s] && e.kill(o, e._op[s]),
              R && e._pt && ((yi = e), te.killTweensOf(o, p, 'started'), (yi = 0)),
              e._pt && S && (qe[d.id] = 1);
          }
      ...
      Ei = (function (t) {
        function s(e, n, s, r) {
          ...
          if (
            ((c._targets = z.length
              ? v(z)
              : p('GSAP target ' + e + ' not found. https://greensock.com', !Te.nullTargetWarn) || []),
              (c._ptLookup = []),
              (c._overwrite = k),
              P || _ || d(T) || d(C))
          ) {
            if (
              ((n = c.vars),
                (u = c.timeline = new bi({ data: 'nested', defaults: $ || {} })).kill(),
                (u.parent = i(c)),
                P)
            )
              ...
              if (((g = z.length), (w = _ ? G(_) : m), o(_)))
                for (b in _) ~Ti.indexOf(b) && ((x = x || {})[b] = _[b]);
              for (h = 0; h < g; h++) {
        ...
        return (
                ...
                if (((n = m), (d = this.timeline), this._repeat)) {
                  ...
                  a !== o &&
                    (!this.vars.repeatRefresh ||
                      l ||
                      this._lock ||
                      ((this._lock = i = 1), (this.render(r * a, !0).invalidate()._lock = 0)));
                }
              ...
              !(function (t, e, i, n) {
                ...
                if (
                  (o &&
                    t._repeat &&
                    ((l = Ze(0, t._tDur, e)),
                      Je(l, o) !== Je(t._tTime, o) &&
                      ((a = 1 - r), t.vars.repeatRefresh && t._initted && t.invalidate())),
                    (t._initted || !j(t, e, n, i)) &&
                  ...
                  !r && t._startAt && !t._onUpdate && t._start && t._startAt.render(e, !0, n),
                    ...
                    (t.ratio && z(t, 1),
                      i ||
                      (ni(t, t.ratio ? 'onComplete' : 'onReverseComplete', !0),
                        t._prom && t._prom()));
                }
              })(this, t, e, i);
            return this;
          ...
          (r.kill = function (t, e) {
            if (
              ...
              return et(this);
            if (this.timeline)
              return this.timeline.killTweensOf(t, e, yi && !0 !== yi.vars.overwrite), this;
            var i,
              s,
              a,
              r,
            ...
            for (
              ...
              (n(e) &&
                ...
                (e = (function (t, e) {
                  ...
                  if (!o) return e;
                  for (n in ((i = Qe({}, e)), o))
                    if ((n in i)) for (s = (a = o[n].split(',')).length; s--;) i[a[s]] = i[n];
                  return i;
                })(d, e))),
              c = d.length;
              c--;
              ...
              if (~u.indexOf(d[c]))
                for (o in ((s = h[c]),
                  'all' === e ? ((i[c] = e), (r = s), (a = {})) : ((a = i[c] = i[c] || {}), (r = e)),
                  r))
                  (l = s && s[o]) &&
                    (('kill' in l.d && !0 !== l.d.kill(o)) || A(this, l, '_pt'), delete s[o]),
                    'all' !== a && (a[o] = 1);
    ...
    var _i = function (t, e, i) {
      ...
      Ii = function (t) {
        for (var e, i, n = this._pt; n;)
          (i = n._next), (n.p === t && !n.op) || n.op === t ? A(this, n, '_pt') : n.dep || (e = 1), (n = i);
        return !e;
      },
      Di = function (t) {
    ...
    var Bi = {
        ...
        e.forEach(function (t) {
          return (function (t) {
            ...
            if ((ci(), t !== n)) {
              if (Ye[e]) return;
              M(n, M($(t, a), r)),
                Qe(n.prototype, Qe(a, $(t, r))),
                (Ye[(n.prop = e)] = n),
                t.targetTest && (Ge.push(n), (Ve[e] = 1)),
      ...
      exportRoot: function (t, e) {
        ...
        for (
          ...
          (n = i._next),
            (!e && !i._dur && i instanceof Ei && i.vars.onComplete === i._targets[0]) ||
      ...
      $n = function (t, e) {
        ...
        return (
          ...
          ((M = !i.uncache && t.getAttribute('data-svg-origin')),
            Qt(t, M || R, !!M || i.originIsAbsolute, !1 !== i.smooth, v)),
          (f = i.xOrigin || 0),
          (m = i.yOrigin || 0),
          v !== kn &&
          ((x = v[0]),
            ...
            6 === v.length
              ...
              : ((I = v[6]),
                ...
                (l = (g = vn(S, x)) * fn),
                g &&
                ((M = x * (b = Math.cos(g)) + S * (y = Math.sin(g))),
                  (k = E * b + _ * y),
                  (S = S * b - x * y),
                  (_ = _ * b - E * y),
                  (x = M),
            ...
            ((v = t.getAttribute('transform')),
              (i.forceCSS = t.setAttribute('transform', '') || !Wt(Ot(t, xn))),
              v && t.setAttribute('transform', v))),
          90 < Math.abs(u) &&
          Math.abs(u) < 270 &&
          (F
            ? ((r *= -1), (u += l <= 0 ? 180 : -180), (l += l <= 0 ? 180 : -180))
            : ((o *= -1), (u += u <= 0 ? 180 : -180))),
          (i.x =
            ((i.xPercent = n && Math.round(t.offsetWidth / 2) === Math.round(-n) ? -50 : 0) ? 0 : n) +
            'px'),
          (i.y =
            ((i.yPercent = s && Math.round(t.offsetHeight / 2) === Math.round(-s) ? -50 : 0) ? 0 : s) +
            'px'),
          (i.z = a + 'px'),
          (i.scaleX = w(r)),
          (i.scaleY = w(o)),
          ...
          h || p
            ? ((h *= mn),
              ...
              ((f *= mn),
                ...
                (s *= r = Math.sqrt(1 + r * r)),
                (a *= r),
                f && ((r = Math.tan(f)), (i *= r = Math.sqrt(1 + r * r)), (n *= r))),
              (i = w(i)),
              (n = w(n)),
              (s = w(s)),
              (a = w(a)))
            : ((i = m), (a = v), (n = s = 0)),
          ((C && !~(d + '').indexOf('px')) || (E && !~(u + '').indexOf('px'))) &&
          ((C = Vt(g, 'x', d, 'px')), (E = Vt(g, 'y', u, 'px'))),
    ...
    var Bn,
      ...
      Hn = {
            ...
            if ('autoRound' !== u && ((r = e[u]), !Ye[u] || !mt(u, e, i, n, t, s)))
              if (
                ...
                if (
                  ((a = Nt(t, u)),
                    (l = parseFloat(a)),
                    (m = 'string' === c && '=' === r.charAt(1) ? +(r.charAt(0) + '1') : 0) &&
                    (r = r.substr(2)),
                    (o = parseFloat(r)),
                    u in wn &&
                    ('autoAlpha' === u &&
                      (1 === l && 'hidden' === Nt(t, 'visibility') && o && (l = 0),
                        Ht(
                          this,
                          S,
                          'visibility',
                  ...
                  if (
                    ...
                    (this._pt = new Fi(this._pt, b, 'scaleY', b.scaleY, m ? m * o : o - b.scaleY)),
                      x.push('scaleY', u),
                      (u += 'X');
                  else {
                    if ('transformOrigin' === u) {
                      (r = Yt(r)),
                        b.svg
                          ? Qt(t, r, 0, y, 0, this)
                          : ((f = parseFloat(r.split(' ')[2]) || 0) !== b.zOrigin &&
                            Ht(this, b, 'zOrigin', b.zOrigin, f),
                            Ht(this, S, u, Ln(a), Ln(r)));
                      continue;
                    }
                    if ('svgOrigin' === u) {
                      Qt(t, r, 1, y, 0, this);
                ...
                if (v || ((o || 0 === o) && (l || 0 === l) && !yn.test(r) && u in S))
                  (p = (a + '').substr((l + '').length)) !==
                    (f =
                      ...
                      (u in Te.units ? Te.units[u] : p)) && (l = Vt(t, u, a, f)),
                    (this._pt = new Fi(
                      this._pt,
                      v ? b : S,
                      u,
        ...
        getSetter: function (t, e, i) {
          ...
          return (
            n && n.indexOf(',') < 0 && (e = n),
            e in pn && e !== Sn && (t._gsap.x || Nt(t, 'x'))
              ? i && Xi === i ? ('scale' === e ? $t : Pt) : (Xi = i || {}) && ('scale' === e ? Lt : At)
              : t.style && !r(t.style[e]) ? Mt : ~e.indexOf('-') ? kt : Pi(t, e)
          );
        },
    ...
    (Ri.utils.checkPrefix = Cn),
      ...
      (wn[jn[13]] = Bn + ',' + Rn),
      y('0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY', function (
        t
      ) {
        var e = t.split(':');
        wn[e[1]] = jn[e[0]];
    ...
    function (t, e, i) {
      ...
      function c(t, e) {
        ('object' === ('undefined' == typeof HTMLElement ? 'undefined' : a(HTMLElement))
          ...
          : t && 'object' === a(t) && null !== t && 1 === t.nodeType && 'string' == typeof t.nodeName) &&
          (t = [t]);
        for (
          var i, n = t.length, s = 0, r = arguments.length, o = new Array(2 < r ? r - 2 : 0), l = 2;
          l < r;
          l++
        )
          o[l - 2] = arguments[l];
        for (; s < n; s += 1)
          if (
            ('object' === a(e) || void 0 === e
              ...
              : t[s].jarallax && (i = t[s].jarallax[e].apply(t[s].jarallax, o)),
              void 0 !== i)
          )
            return i;
        return t;
      ...
      var d,
        ...
        v =
          -1 < m.userAgent.indexOf('MSIE ') ||
          -1 < m.userAgent.indexOf('Trident/') ||
          -1 < m.userAgent.indexOf('Edge/'),
          ...
          function t(e, i) {
            ...
            Object.keys(l).forEach(function (t) {
              ...
              Object.keys(s.options).forEach(function (t) {
                'true' === s.options[t]
                  ? (s.options[t] = !0)
                  : 'false' === s.options[t] && (s.options[t] = !1);
              }),
              (s.options.speed = Math.min(2, Math.max(-1, parseFloat(s.options.speed)))),
              'string' == typeof s.options.disableParallax &&
              (s.options.disableParallax = new RegExp(s.options.disableParallax)),
              ...
              'string' == typeof s.options.disableVideo &&
              (s.options.disableVideo = new RegExp(s.options.disableVideo)),
                  ...
                  n.options.keepImg ||
                    ((t = n.$item.getAttribute('style')) &&
                      ...
                      ((e = n.image.$item.getAttribute('style')) &&
                        n.image.$item.setAttribute('data-jarallax-original-styles', e))),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return (
                    s &&
                    (n < 0
                      ? ((a = n * Math.max(i, u)), u < i && (a -= n * (i - u)))
                      : (a = n * (i + u)),
                      1 < n
                        ? (r = Math.abs(a - u))
                        : n < 0 ? (r = a / n + Math.abs(a)) : (r += (u - i) * (1 - n)),
                      (a /= 2)),
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  h.options.elementInViewport &&
                    (b = h.options.elementInViewport.getBoundingClientRect()),
                    (h.isElementInViewport =
                      0 <= b.bottom &&
                      0 <= b.right &&
                      b.top <= u &&
                      b.left <= f.window.innerWidth),
                    ...
                    ((e = Math.max(0, m)),
                      ...
                      ((g.transform = 'translate3d(0,0,0)'), (g.opacity = l)),
                      ('scale' !== h.options.type && 'scale-opacity' !== h.options.type) ||
                      ((c = 1),
                        h.options.speed < 0
                          ? (c -= h.options.speed * l)
                          : (c += h.options.speed * (1 - l)),
                        (g.transform = 'scale('.concat(c, ') translate3d(0,0,0)'))),
                      ('scroll' !== h.options.type && 'scroll-opacity' !== h.options.type) ||
                      ((d = h.parallaxScrollDistance * o),
                        'absolute' === h.image.position && (d -= m),
                        (g.transform = 'translate3d(0,'.concat(d, 'px,0)'))),
      ...
      i.extend(v.prototype, {
          ...
          o.closeExisting && i.fancybox.close(!0),
            ...
            (n = i(
              a.translate(
                ...
                o.baseTpl
                  .replace('{{buttons}}', s)
                  .replace('{{arrows}}', o.btnTpl.arrowLeft + o.btnTpl.arrowRight)
              )
            )
          ...
          i.each(s, function (t, e) {
            ...
            i.isPlainObject(e)
              ...
              ((r = o.match(/\.(mp4|mov|ogv|webm)((\?|#).*)?$/i))
                ? ((a = 'video'),
                  c.opts.video.format ||
                  (c.opts.video.format = 'video/' + ('ogv' === r[1] ? 'ogg' : r[1])))
                : o.match(
              ...
              c.contentType ||
              (c.contentType =
                i.inArray(c.type, ['html', 'inline', 'ajax']) > -1 ? 'html' : c.type),
              (c.index = n.group.length),
              'auto' == c.opts.smallBtn &&
              (c.opts.smallBtn = i.inArray(c.type, ['html', 'inline', 'ajax']) > -1),
              ...
              'ajax' === c.type &&
              ((l = o.split(/\s+/, 2)),
                l.length > 1 && ((c.src = l.shift()), (c.opts.filter = l.shift()))),
              c.opts.modal &&
            ...
            (n.updateControls(), (e = n.Thumbs) && e.isActive && (e.create(), e.focus()));
        },
        addEvents: function () {
          var e = this;
          e.removeEvents(),
        ...
        jumpTo: function (t, e) {
          ...
          if (!(h.isDragging || h.isClosing || (h.isAnimating && h.firstRun))) {
            if (
              ((t = parseInt(t, 10)),
                !(a = h.current ? h.current.opts.loop : h.opts.loop) && (t < 0 || t >= f))
            )
              return !1;
            if (
              ((n = h.firstRun = !Object.keys(h.slides).length),
                ...
                (r = h.createSlide(t)),
                f > 1 &&
                ((a || r.index < f - 1) && h.createSlide(t + 1),
                  (a || r.index > 0) && h.createSlide(t - 1)),
                (h.current = r),
                (h.currIndex = r.index),
                (h.currPos = r.pos),
                ...
                ? ((u = l.left - (o.pos * l.width + o.pos * o.opts.gutter)),
                  i.each(h.slides, function (t, n) {
                    ...
                    i.fancybox.setTranslate(n.$slide, { top: 0, left: s - c.left + u }),
                      n.pos !== r.pos &&
                      n.$slide.addClass(
                        'fancybox-slide--' + (n.pos > r.pos ? 'next' : 'previous')
                      ),
                      p(n.$slide),
                      i.fancybox.animate(
                        n.$slide,
        ...
        createSlide: function (t) {
          ...
          return (
            ...
            !s.slides[t] &&
            s.group[n] &&
            ((e = i('<div class="fancybox-slide"></div>').appendTo(s.$refs.stage)),
              (s.slides[t] = i.extend(!0, {}, s.group[n], { pos: t, $slide: e, isLoaded: !1 })),
        ...
        getFitPos: function (t) {
          ...
          return (
            ...
            ((e = i.fancybox.getTranslate(r.$refs.stage).width),
              ...
              d > n - 0.5 && (d = n),
              'image' === t.type
                ? ((u.top = Math.floor(0.5 * (n - d)) + parseFloat(l.css('paddingTop'))),
                  (u.left = Math.floor(0.5 * (e - c)) + parseFloat(l.css('paddingLeft'))))
                : 'video' === t.contentType &&
                ((a = t.opts.width && t.opts.height ? c / d : t.opts.ratio || 16 / 9),
        ...
        isMoved: function (t) {
          ...
          return (
            ...
            ((n = i.fancybox.getTranslate(this.$refs.stage)),
              ...
              (Math.abs(e.top - n.top) > 0.5 || Math.abs(e.left - n.left) > 0.5))
          );
        },
              ...
              n
                ...
                : s &&
                  ('zoom' === r.opts.clickContent ||
                    (i.isFunction(r.opts.clickContent) && 'zoom' == r.opts.clickContent(r)))
        ...
        isScaledDown: function (t, e) {
          ...
          return (
            void 0 !== t && void 0 !== e
              ...
              : r && ((s = i.fancybox.getTranslate(r)), (s = s.width < a.width && s.height < a.height)),
            s
          );
        },
        canPan: function (t, e) {
          ...
          if (r) {
            (s = t.devicePixelRatio || 1),
              ...
              (n = r.split(',').map(function (t) {
                var e = {};
                return (
                  t.trim().split(/\s+/).forEach(function (t, i) {
        ...
        setBigImage: function (t) {
          ...
          (t.$image = a
            ...
            .one('load', function () {
              var e;
              t.$ghost ||
                (n.resolveImageSlideSize(t, this.naturalWidth, this.naturalHeight), n.afterLoad(t)),
                n.isClosing ||
                (t.opts.srcset &&
                  ((e = t.opts.sizes),
                    (e && 'auto' !== e) ||
            ...
            .attr('src', t.src)
            .appendTo(t.$content)),
            (s.complete || 'complete' == s.readyState) && a.naturalWidth && a.naturalHeight
              ? a.trigger('load')
        ...
        setIframe: function (t) {
          var e,
            ...
            a = t.$slide;
          (t.$content = i(
            '<div class="fancybox-content' + (s.preload ? ' fancybox-is-hidden' : '') + '"></div>'
          )
            .css(s.css)
            .appendTo(a)),
                  ...
                  if (1 === e[0].isReady) {
                    ...
                    n &&
                      ...
                      (a.css('overflow', 'visible'),
                        ...
                        void 0 === l &&
                        (l = Math.ceil(Math.max(n[0].clientHeight, n.outerHeight(!0)))),
                        r.css('height', l || ''),
                        a.css('overflow', 'auto')),
          ...
          n.isClosing ||
            (n.hideLoading(t),
              ...
              c(e) && e.parent().length
                ...
                : t.hasError ||
                ('string' === i.type(e) && (e = i('<div>').append(i.trim(e)).contents()),
        ...
        showLoading: function (t) {
          ...
          (t = t || e.current) &&
            !t.$spinner &&
            (t.$spinner = i(e.translate(e, e.opts.spinnerTpl)).appendTo(t.$slide).hide().fadeIn('fast'));
        },
        ...
        afterLoad: function (t) {
          ...
          e.isClosing ||
            ((t.isLoading = !1),
              ...
              (t.$smallBtn = i(e.translate(t, t.opts.btnTpl.smallBtn)).appendTo(t.$content)),
              t.opts.protect &&
              t.$content &&
              !t.hasError &&
        ...
        revealContent: function (t) {
          ...
          return (
            ...
            'zoom' === e &&
            (t.pos === r.currPos && s && 'image' === t.type && !t.hasError && (c = r.getThumbPos(t))
              ? (l = r.getFitPos(t))
              : (e = 'fade')),
            'zoom' === e
              ? ((r.isAnimating = !0),
          ...
          r.isClosing ||
            ((s =
              !t && r.current && r.current.isComplete
                ? r.current.$slide.find('*:visible' + (n ? ':not(.fancybox-close-small)' : ''))
              ...
              s.length
                ? ((a = s.index(e.activeElement)),
                  t && t.shiftKey
                    ? (a < 0 || 0 == a) && (t.preventDefault(), s.eq(s.length - 1).trigger('focus'))
                    : (a < 0 || a == s.length - 1) && (t && t.preventDefault(), s.eq(0).trigger('focus')))
        ...
        (i.fancybox = {
          ...
          getInstance: function (t) {
            ...
            return (
              e instanceof v &&
              ('string' === i.type(t) ? e[t].apply(e, n) : 'function' === i.type(t) && t.apply(e, n), e)
            );
          },
          open: function (t, e, i) {
            return new v(t, e, i);
        ...
        (i.fn.fancybox = function (t) {
          ...
          return (
            ...
            (e = t.selector || !1),
            e
              ? i('body').off('click.fb-start', e).on('click.fb-start', e, { options: t }, s)
              : this.off('click.fb-start').on('click.fb-start', { items: this, options: t }, s),
            this
          );
        }),
        ...
        f
          ? (a.opts.thumb || (a.opts.$thumb && a.opts.$thumb.length) || (a.opts.thumb = o),
            ...
            t.extend(a, {
              ...
              contentSource: h,
              contentType:
                'image' === f ? 'image' : 'gmap_place' == h || 'gmap_search' == h ? 'map' : 'video'
            }))
    ...
    var n = (function () {
      ...
      r = function (t, e, i) {
        return e && t
          ? 'x' === i
            ? t.x - e.x
            : 'y' === i ? t.y - e.y : Math.sqrt(Math.pow(t.x - e.x, 2) + Math.pow(t.y - e.y, 2))
          : 0;
      },
      o = function (t) {
        if (
    ...
    (d.prototype.destroy = function () {
      ...
      (d.prototype.ontouchstart = function (n) {
        ...
        if (
          (f && s.$container.off('mousedown.fb.touch'),
            ...
            !o(l) &&
            !o(l.parent()) &&
            (l.is('img') || !(n.originalEvent.clientX > l[0].clientWidth + l.offset().left)))
        ) {
          ...
          (s.realPoints = s.startPoints = a(n)),
            ...
            (u.touch && n.stopPropagation(),
              ...
              (((s.opts || s.canPan) && (l.is(s.$stage) || s.$stage.find(l).length)) ||
                (l.is('.fancybox-image') && n.preventDefault(),
                  i.fancybox.isMobile && l.parents('.fancybox-caption').length)) &&
              ((s.isScrollable = c(l) || c(l.parent())),
                (i.fancybox.isMobile && s.isScrollable) || n.preventDefault(),
                (1 === s.startPoints.length || u.hasError) &&
                (s.canPan ? (i.fancybox.stop(s.$content), (s.isPanning = !0)) : (s.isSwiping = !0),
                ...
                ((s.canTap = !1),
                  ...
                  (s.centerPointStartX =
                    0.5 * (s.startPoints[0].x + s.startPoints[1].x) - i(t).scrollLeft()),
                  (s.centerPointStartY =
                    0.5 * (s.startPoints[0].y + s.startPoints[1].y) - i(t).scrollTop()),
            ...
            ((r.canTap = !1),
              o.group.length < 2 && r.opts.vertical
                ...
                : o.isDragging ||
                  ...
                  ? (r.isSwiping = 'x')
                  : ((a = Math.abs(180 * Math.atan2(r.distanceY, r.distanceX) / Math.PI)),
          ...
          (o.isDragging = r.isSwiping),
            ...
            i.each(o.slides, function (t, e) {
              ...
              i.fancybox.stop(e.$slide),
                ...
                e.pos === o.current.pos &&
                ((r.sliderStartPos.top = n.top - s.top), (r.sliderStartPos.left = n.left - s.left)),
      ...
      (d.prototype.limitPosition = function (t, e, i, n) {
        var s = this,
          ...
          r = s.canvasHeight;
        return (
          i > a ? ((t = t > 0 ? 0 : t), (t = t < a - i ? a - i : t)) : (t = Math.max(0, a / 2 - i / 2)),
        ...
        (n.sliderLastPos = null),
          'y' == t && !e && Math.abs(n.distanceY) > 50
            ? (i.fancybox.animate(
              ...
              { top: n.sliderStartPos.top + n.distanceY + 150 * n.velocityY, opacity: 0 },
              200
            ),
      ...
      init: function () {
        ...
        (t.$button = i.$refs.toolbar.find('[data-fancybox-play]').on('click', function () {
          ...
          i.group.length < 2 || !n
            ? t.$button.hide()
            : n.progress &&
            (t.$progress = e('<div class="fancybox-progress"></div>').appendTo(i.$refs.inner));
      },
      set: function (t) {
        var i = this,
          n = i.instance,
        ...
        e(t).on(i.fullscreenchange, function () {
          ...
          i &&
            (i.current &&
              ...
              i.isAnimating &&
              ((i.isAnimating = !1), i.update(!0, !0, 0), i.isComplete || i.complete()),
    ...
    e.extend(n.prototype, {
      ...
      create: function () {
        var t,
          ...
          r = [];
        n.$grid ||
          ((n.$grid = e('<div class="' + i + ' ' + i + '-' + n.opts.axis + '"></div>').appendTo(
            s.$refs.container.find(a).addBack().filter(a)
          )),
        ...
        n.instance.current &&
          ((e = s
            ...
            'y' === n.opts.axis && (i.top < 0 || i.top > s.height() - e.outerHeight())
              ...
              : 'x' === n.opts.axis &&
              (i.left < a.scrollLeft() || i.left > a.scrollLeft() + (a.width() - e.outerWidth())) &&
  ...
  (function (t, e, i) {
    ...
    function a(t) {
      ...
      return (
        !!t &&
        ((e = t.current ? t.current.opts : t.opts),
          '' !== (i = e.hash || (e.$orig ? e.$orig.data('fancybox') || e.$orig.data('fancybox-trigger') : '')) &&
          i)
      );
    }
    i.escapeSelector ||
          ...
          (i(e).on({
            'onInit.fb': function (t, e) {
              ...
              !1 !== e.group[e.currIndex].opts.hash &&
                ((i = n()), (s = a(e)) && i.gallery && s == i.gallery && (e.currIndex = i.index - 1));
            },
                    ...
                    (n.hashTimer = setTimeout(function () {
                      'replaceState' in t.history
                        ? (t.history[r ? 'pushState' : 'replaceState'](
                          {},
                          e.title,
                          t.location.pathname + t.location.search + '#' + n.currentHash
                        ),
                  ...
                  n.currentHash && n.hasCreatedHistory
                    ...
                    ('replaceState' in t.history
                      ? t.history.replaceState(
                        {},
                        e.title,
                        t.location.pathname + t.location.search + (n.origHash || '')
                      )
  ...
  (function (t) {
    ...
    function e() {
      ...
      return (
        n.height ||
        (((e = l.compatMode) || !t.support.boxModel) &&
          ((i = 'CSS1Compat' === e ? d : l.body),
        ...
        for (s = s || e(), a = a || i(); n < o.length; n++)
          if (t.contains(d, r[n][0])) {
            var l = t(r[n]),
              ...
              h = l.data('inview');
            if (!a || !s) return;
            u.top + c.height > a.top &&
              u.top < a.top + s.height &&
              u.left + c.width > a.left &&
              u.left < a.left + s.width
              ? h || l.data('inview', !0).trigger('inview', [!0])
              : h && l.data('inview', !1).trigger('inview', [!1]);
          }
      }
    }
    var s,
  ...
  (function (t, e, i, n) {
    ...
    t.fn.pagepiling = function (s) {
          ...
          void 0 === n.animated && (n.animated = !0),
            ...
            'down' === n.yMovement
              ...
              : ((n.translate3d = 'translate3d(0px, 0px, 0px)'),
                (n.scrolling = '0'),
                (n.animateSection = e)),
            t.isFunction(J.onLeave) &&
            J.onLeave.call(this, n.leavingSection, n.sectionIndex + 1, n.yMovement),
            l(n),
            F(n.anchorLink),
      ...
      function f(e) {
        (e = e.replace('#', '')),
          (t('body')[0].className = t('body')[0].className.replace(/\b\s?pp-viewing-[^\s]+\b/g, '')),
      ...
      function S(t, e) {
        var i, n;
        if (
          ('down' == t ? ((i = 'bottom'), (n = H.moveSectionDown)) : ((i = 'top'), (n = H.moveSectionUp)),
            e.length > 0)
        ) {
          if (!T(i, e)) return !0;
          n();
      ...
      function T(t, e) {
        return 'top' === t
          ? !e.scrollTop()
          : 'bottom' === t ? e.scrollTop() + 1 + e.innerHeight() >= e[0].scrollHeight : void 0;
      }
      function C(t) {
        return t.filter('.pp-scrollable');
      }
      function E() {
        V.get(0).addEventListener
          ? (V.get(0).removeEventListener('mousewheel', w, !1), V.get(0).removeEventListener('wheel', w, !1))
          : V.get(0).detachEvent('onmousewheel', w);
      }
      function _() {
        V.get(0).addEventListener
          ? (V.get(0).addEventListener('mousewheel', w, !1), V.get(0).addEventListener('wheel', w, !1))
          : V.get(0).attachEvent('onmousewheel', w);
      }
      function M() {
        if (q) {
          var t = P();
          V.off('touchstart ' + t.down).on('touchstart ' + t.down, A),
            V.off('touchmove ' + t.move).on('touchmove ' + t.move, z);
        }
      }
      function k() {
        if (q) {
      ...
      function $(t) {
        var e = new Array();
        return (
          (e.y = void 0 !== t.pageY && (t.pageY || t.pageX) ? t.pageY : t.touches[0].pageY),
          ...
          if ((s.length || e.preventDefault(), !v())) {
            ...
            (W = a.y),
              ...
              'horizontal' === J.direction && Math.abs(X - G) > Math.abs(Y - W)
                ? Math.abs(X - G) > V.width() / 100 * J.touchSensitivity &&
                (X > G ? S('down', s) : G > X && S('up', s))
                : Math.abs(Y - W) > V.height() / 100 * J.touchSensitivity &&
                (Y > W ? S('down', s) : W > Y && S('up', s));
          }
        }
      }
      function O(e, i) {
        ...
        var n = t(e).parent();
        return (
          !!(i < J.normalScrollElementTouchThreshold && n.is(J.normalScrollElements)) ||
          (i != J.normalScrollElementTouchThreshold && O(n, ++i))
        );
      }
      function I() {
      ...
      function D(e, i) {
        J.navigation &&
          (t('#pp-nav').find('.active').removeClass('active'),
            e
              ? t('#pp-nav').find('a[href="#' + e + '"]').addClass('active')
              : t('#pp-nav').find('li').eq(i).find('a').addClass('active'));
      }
      function F(e) {
        J.menu &&
          (t(J.menu).find('.active').removeClass('active'),
            t(J.menu).find('[data-menuanchor="' + e + '"]').addClass('active'));
      }
      function B() {
        ...
        for (var a in s)
          t.style[a] !== n &&
            ((t.style[a] = 'translate3d(1px,1px,1px)'), i.getComputedStyle(t).getPropertyValue(s[a]));
      ...
      t.extend(t.easing, {
        ...
        (H.moveTo = function (i) {
          var n = '';
          (n = isNaN(i) ? t(e).find('[data-anchor="' + i + '"]') : t('.pp-section').eq(i - 1)),
            n.length > 0 && o(n);
        }),
      ...
      t('.pp-section')
        ...
        .done(function () {
          J.navigation &&
            (t('#pp-nav').css('margin-top', '-' + t('#pp-nav').height() / 2 + 'px'),
              t('#pp-nav')
                .find('li')
  ...
  (function (t) {
    ...
    t.extend(t.fn, {
              ...
              this.on('submit.validate', function (e) {
                ...
                return (
                  ...
                  i.cancelSubmit
                    ? ((i.cancelSubmit = !1), n())
                    : i.form()
                      ? i.pendingRequest ? ((i.formSubmitted = !0), !1) : n()
                      : (i.focusInvalid(), !1)
                );
              })),
            i)
      ...
      rules: function (e, i) {
        ...
        if (
          null != c &&
          (!c.form && d && ((c.form = this.closest('form')[0]), (c.name = this.attr('name'))), null != c.form)
        ) {
          if (e)
      ...
      t.extend(t.validator, {
        ...
        prototype: {
          ...
          check: function (e) {
            ...
            'function' == typeof r.normalizer
              ? (a = r.normalizer)
              : 'function' == typeof this.settings.normalizer && (a = this.settings.normalizer),
            ...
            for (n in r) {
              ...
              try {
                if (
                  'dependency-mismatch' ===
                  (i = t.validator.methods[n].call(this, c, e, s.parameters)) &&
                  1 === o
                ) {
                  l = !0;
                  continue;
          ...
          customDataMessage: function (e, i) {
            return (
              t(e).data('msg' + i.charAt(0).toUpperCase() + i.substring(1).toLowerCase()) ||
              t(e).data('msg')
            );
          },
          ...
          defaultMessage: function (e, i) {
            ...
            return (
              'function' == typeof n
                ...
                : s.test(n) && (n = t.validator.format(n.replace(s, '{$1}'), i.parameters)),
              n
            );
          },
          ...
          showLabel: function (e, i) {
            ...
            o.length
              ...
              : ((o = t('<' + this.settings.errorElement + '>')
                ...
                (n = o.hide().show().wrap('<' + this.settings.wrapper + '/>').parent()),
                ...
                o.is('label')
                  ...
                  ((a = o.attr('id')),
                    c
                      ? c.match(new RegExp('\\b' + this.escapeCssMeta(a) + '\\b')) || (c += ' ' + a)
                      : (c = a),
                    ...
                    ((r = this),
                      t.each(r.groups, function (e, i) {
                        i === s &&
                          t("[name='" + r.escapeCssMeta(e) + "']", r.currentForm).attr(
                            'aria-describedby',
                            o.attr('id')
                          );
                      })))),
          ...
          errorsFor: function (e) {
            ...
            return (
              n && (s = s + ', #' + this.escapeCssMeta(n).replace(/\s+/g, ', #')), this.errors().filter(s)
            );
          },
        ...
        attributeRules: function (e) {
          ...
          for (i in t.validator.methods)
            'required' === i ? ((n = e.getAttribute(i)), '' === n && (n = !0), (n = !!n)) : (n = a.attr(i)),
            ...
            t.each(e, function (n, s) {
              ...
              if (s.param || s.depends) {
                ...
                a
                  ...
                  : (t.data(i.form, 'validator').resetElements(t(i)), delete e[n]);
              }
            }),
            t.each(e, function (n, s) {
        ...
        methods: {
          ...
          dateISO: function (t, e) {
            return (
              this.optional(e) || /^\d{4}[\/\-](0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])$/.test(t)
            );
          },
          number: function (t, e) {
                        ...
                        success: function (t) {
                          ...
                          (a.settings.messages[i.name][s] = l.originalMessage),
                            c
                              ...
                              : ((n = {}),
                                (r =
                                  t || a.defaultMessage(i, { method: s, parameters: e })),
  ...
  (function (t, e) {
    'object' == typeof exports && 'undefined' != typeof module
      ? (module.exports = e())
      : 'function' == typeof define && define.amd ? define(e) : ((t = t || self).Swiper = e());
  })(this, function () {
    'use strict';
    function t(t) {
    ...
    function e(i, n) {
      void 0 === i && (i = {}),
        ...
        Object.keys(n).forEach(function (s) {
          void 0 === i[s]
            ? (i[s] = n[s])
            : t(n[s]) && t(i[s]) && Object.keys(n[s]).length > 0 && e(i[s], n[s]);
        });
    }
    function i(t, e) {
      var i = [],
        ...
        if ('string' == typeof t) {
          ...
          if (r.indexOf('<') >= 0 && r.indexOf('>') >= 0) {
            ...
            for (
              s =
              e || '#' !== t[0] || t.match(/[ .<>:~]/)
                ? (e || u).querySelectorAll(t.trim())
                : [u.getElementById(t.trim().split('#')[1])],
              n = 0;
              n < s.length;
              n += 1
            )
      ...
      if (!this.animating || !n.preventInteractionOnTransition) {
        ...
        if (
          ...
          ((e.isTouchEvent = 'touchstart' === a.type),
            ...
            !((!e.isTouchEvent && 'button' in a && a.button > 0) || (e.isTouched && e.isMoved)))
        )
          if (n.noSwiping && r.closest(n.noSwipingSelector ? n.noSwipingSelector : '.' + n.noSwipingClass)[0])
            ...
            if (!c || !(o <= d || o >= p.screen.width - d)) {
              if (
                ...
                var h = !0;
                r.is(e.formElements) && (h = !1),
                  u.activeElement &&
                  i(u.activeElement).is(e.formElements) &&
                  u.activeElement !== r[0] &&
        ...
        if (!e.isTouchEvent || 'touchmove' === r.type) {
          ...
          if (!this.allowTouchMove)
            return (
              ...
              void (
                e.isTouched &&
                (v.extend(s, { startX: l, startY: c, currentX: l, currentY: c }),
                  (e.touchStartTime = v.now()))
              )
            );
          ...
          if (
            ...
            if (
              !(
                ...
                Math.sqrt(Math.pow(d, 2) + Math.pow(h, 2)) < this.params.threshold
              )
            ) {
              var p;
              if (
                (void 0 === e.isScrolling &&
                  ((this.isHorizontal() && s.currentY === s.startY) ||
                    ...
                    ? (e.isScrolling = !1)
                    : d * d + h * h >= 25 &&
                    ((p = 180 * Math.atan2(Math.abs(h), Math.abs(d)) / Math.PI),
                      (e.isScrolling = this.isHorizontal()
                        ? p > n.touchAngle
                        : 90 - p > n.touchAngle))),
                  e.isScrolling && this.emit('touchMoveOpposite', r),
                  void 0 === e.startMoving &&
                  ((s.currentX === s.startX && s.currentY === s.startY) || (e.startMoving = !0)),
                  e.isScrolling)
              )
                e.isTouched = !1;
                    ...
                    f > 0 && e.currentTranslate > this.minTranslate()
                      ? ((m = !1),
                        ...
                        (e.currentTranslate =
                          this.minTranslate() -
                          1 +
                          Math.pow(-this.minTranslate() + e.startTranslate + f, g)))
                      : f < 0 &&
                      ...
                      ((m = !1),
                        ...
                        (e.currentTranslate =
                          this.maxTranslate() +
                          1 -
                          Math.pow(this.maxTranslate() - e.startTranslate - f, g))),
    ...
    function r(t) {
      ...
      if (
        (e.allowClick &&
          (e.updateClickedSlide(c),
            e.emit('tap click', c),
            h < 300 && u - i.lastClickTime < 300 && e.emit('doubleTap doubleClick', c)),
      ...
      if (
        ((i.isTouched = !1),
          (i.isMoved = !1),
          (i.startMoving = !1),
          (d = n.followFinger ? (a ? e.translate : -e.translate) : -i.currentTranslate),
          !n.cssMode)
      )
        if (n.freeMode) {
          ...
          if (n.freeModeMomentum) {
            ...
            if (w < e.maxTranslate())
              ...
              w = -(w =
                Math.abs(l[E] - w) < Math.abs(l[E - 1] - w) || 'next' === e.swipeDirection
                  ? l[E]
                  : l[E - 1]);
            }
            if (
          ...
          if (h > n.longSwipesMs) {
            ...
            'next' === e.swipeDirection && (z >= n.longSwipesRatio ? e.slideTo(P + O) : e.slideTo(P)),
              'prev' === e.swipeDirection &&
              (z > 1 - n.longSwipesRatio ? e.slideTo(P + O) : e.slideTo(P));
          } else {
            ...
            !e.navigation || (c.target !== e.navigation.nextEl && c.target !== e.navigation.prevEl)
              ...
              : c.target === e.navigation.nextEl ? e.slideTo(P + O) : e.slideTo(P);
          }
        }
    }
    function o() {
      ...
      if (!e || 0 !== e.offsetWidth) {
        ...
        (this.allowSlideNext = !0),
          ...
          ('auto' === t.slidesPerView || t.slidesPerView > 1) && this.isEnd && !this.params.centeredSlides
    ...
    function c() {
      ...
      (this.previousTranslate = this.translate),
        this.isHorizontal()
          ? (this.translate = e ? t.scrollWidth - t.offsetWidth - t.scrollLeft : -t.scrollLeft)
    ...
    var m = {
      ...
      next: function (t) {
        return new f(
          this.length > 0
            ? t
              ? this[0].nextElementSibling && i(this[0].nextElementSibling).is(t)
          ...
          return new f(
            t
              ? e.previousElementSibling && i(e.previousElementSibling).is(t)
                ...
                : []
              : e.previousElementSibling ? [e.previousElementSibling] : []
          );
        }
        return new f([]);
      },
      ...
      parent: function (t) {
        for (var e = [], s = 0; s < this.length; s += 1)
          null !== this[s].parentNode &&
            (t ? i(this[s].parentNode).is(t) && e.push(this[s].parentNode) : e.push(this[s].parentNode));
        return i(n(e));
      },
      parents: function (t) {
        for (var e = [], s = 0; s < this.length; s += 1)
        ...
        return (
          p.WebKitCSSMatrix
            ...
            : (i = (s =
              ...
              .split(',')),
          'x' === e &&
          (n = p.WebKitCSSMatrix ? s.m41 : 16 === i.length ? parseFloat(i[12]) : parseFloat(i[4])),
          'y' === e &&
          (n = p.WebKitCSSMatrix ? s.m42 : 16 === i.length ? parseFloat(i[13]) : parseFloat(i[5])),
          n || 0
        );
      },
    ...
    var w,
      ...
      I = {
        ...
        updateSlides: function () {
          ...
          if (void 0 !== n) {
            ...
            'string' == typeof y && y.indexOf('%') >= 0 && (y = parseFloat(y.replace('%', '')) / 100 * n),
              ...
              e.slidesPerColumn > 1 &&
              ((T =
                Math.floor(c / e.slidesPerColumn) === c / this.params.slidesPerColumn
                  ? c
            ...
            for (
              var E, _ = e.slidesPerColumn, M = T / _, k = Math.floor(c / e.slidesPerColumn), P = 0;
              P < c;
              P += 1
            ) {
              C = 0;
              ...
              if (e.slidesPerColumn > 1) {
                ...
                if ('row' === e.slidesPerColumnFill && e.slidesPerGroup > 1) {
                  ...
                  (L = (A = I - (z = Math.floor(I / D)) * D + O * e.slidesPerGroup) + z * T / _),
                    $.css({
                  ...
                  'column' === e.slidesPerColumnFill
                    ? ((z = P - (A = Math.floor(P / _)) * _),
                      (A > k || (A === k && z === _ - 1)) && (z += 1) >= _ && ((z = 0), (A += 1)))
                    : (A = P - (z = Math.floor(P / M)) * M);
                $.css(
            ...
            if (!e.centeredSlides) {
              ...
              (d = E),
                Math.floor(this.virtualSize - n) - Math.floor(d[d.length - 1]) > 1 &&
                d.push(this.virtualSize - n);
            }
            if (
              (0 === d.length && (d = [0]),
                0 !== e.spaceBetween &&
        ...
        updateSlidesClasses: function () {
          ...
          e.removeClass(
            ...
            (t = r
              ? this.$wrapperEl.find('.' + i.slideClass + '[data-swiper-slide-index="' + s + '"]')
        ...
        updateClickedSlide: function (t) {
          ...
          (this.clickedSlide = n),
            this.virtual && this.params.virtual.enabled
              ? (this.clickedIndex = parseInt(i(n).attr('data-swiper-slide-index'), 10))
      ...
      D = {
        ...
        setTranslate: function (t, e) {
          ...
          this.isHorizontal() ? (o = i ? -t : t) : (l = t),
            ...
            n.cssMode
              ? (a[this.isHorizontal() ? 'scrollLeft' : 'scrollTop'] = this.isHorizontal() ? -o : -l)
              : n.virtualTranslate || s.transform('translate3d(' + o + 'px, ' + l + 'px, 0px)'),
            (this.previousTranslate = this.translate),
          ...
          if (((c = n && t > d ? d : n && t < u ? u : t), r.updateProgress(c), o.cssMode)) {
            ...
            return (
              0 === e
                ...
                : l.scrollTo
                  ? l.scrollTo((((a = {})[h ? 'left' : 'top'] = -c), (a.behavior = 'smooth'), a))
                  : (l[h ? 'scrollLeft' : 'scrollTop'] = -c),
              !0
            );
          }
      ...
      B = {
          ...
          if (o.cssMode) {
            ...
            return (
              ...
              0 === e
                ...
                : p.scrollTo
                  ? p.scrollTo((((s = {})[y ? 'left' : 'top'] = w), (s.behavior = 'smooth'), s))
                  : (p[y ? 'scrollLeft' : 'scrollTop'] = w),
              !0
            );
          }
        ...
        slideToClosest: function (t, e, i, n) {
          ...
          return (
            (s = Math.max(s, 0)), (s = Math.min(s, this.slidesGrid.length - 1)), this.slideTo(s, t, e, i)
          );
        },
      ...
      R = {
        loopCreate: function () {
          ...
          for (var h = l.length - 1; h >= 0; h -= 1)
            n.prepend(i(l[h].cloneNode(!0)).addClass(e.slideDuplicateClass));
        },
        loopFix: function () {
      ...
      H = {
        ...
        addSlide: function (t, e) {
          var i = this.$wrapperEl,
            ...
            s = this.activeIndex;
          n.loop &&
            ((s -= this.loopedSlides), this.loopDestroy(), (this.slides = i.children('.' + n.slideClass)));
        ...
        removeSlide: function (t) {
          var e = this.params,
            ...
            n = this.activeIndex;
          e.loop &&
            ((n -= this.loopedSlides), this.loopDestroy(), (this.slides = i.children('.' + e.slideClass)));
          var s,
            a = n;
          if ('object' == typeof t && 'length' in t) {
            for (var r = 0; r < t.length; r += 1)
              (s = t[r]), this.slides[s] && this.slides.eq(s).remove(), s < a && (a -= 1);
            a = Math.max(a, 0);
          } else
            (s = t), this.slides[s] && this.slides.eq(s).remove(), s < a && (a -= 1), (a = Math.max(a, 0));
      ...
      V = ((w = p.navigator.platform),
        ...
        (S.osVersion = x.toLowerCase().split('version/')[1].split(' ')[0]),
        (S.webView =
          !(!(k || _ || M) || (!x.match(/.*AppleWebKit(?!.*Safari)/i) && !p.navigator.standalone)) ||
          ...
          attachEvents: function () {
            ...
            if (!g.touch && g.pointerEvents)
              i.addEventListener(e.start, this.onTouchStart, !1),
                u.addEventListener(e.move, this.onTouchMove, h),
              ...
              if (g.touch) {
                ...
                i.addEventListener(e.start, this.onTouchStart, p),
                  i.addEventListener(
                    e.move,
                    this.onTouchMove,
                    g.passiveListener ? { passive: !1, capture: h } : h
                  ),
              ...
              ((t.simulateTouch && !V.ios && !V.android) || (t.simulateTouch && !g.touch && V.ios)) &&
                (i.addEventListener('mousedown', this.onTouchStart, !1),
                  u.addEventListener('mousemove', this.onTouchMove, h),
                    ...
                    void 0 !== e &&
                      (o[t] =
                        'slidesPerView' !== t || ('AUTO' !== e && 'auto' !== e)
                          ? 'slidesPerView' === t ? parseFloat(e) : parseInt(e, 10)
                          : 'auto');
                  });
        ...
        classes: {
          addClasses: function () {
            ...
            s.push('initialized'),
              ...
              i && s.push('rtl'),
              e.slidesPerColumn > 1 &&
              (s.push('multirow'), 'column' === e.slidesPerColumnFill && s.push('multirow-column')),
          ...
          if ((s = d[0])) {
            ...
            return (
              ...
              s && s.shadowRoot && s.shadowRoot.querySelector
                ? ((h = i(s.shadowRoot.querySelector('.' + l.params.wrapperClass))).children = function (
                  t
                ) {
                  return d.children(t);
                })
          ...
          (e.prototype.slidesPerViewDynamic = function () {
            ...
            if (t.centeredSlides) {
              for (var r, o = e[s].swiperSlideSize, l = s + 1; l < e.length; l += 1)
                e[l] && !r && ((a += 1), (o += e[l].swiperSlideSize) > n && (r = !0));
              for (var c = s - 1; c >= 0; c -= 1)
                e[c] && !r && ((a += 1), (o += e[c].swiperSlideSize) > n && (r = !0));
      ...
      et = {
        update: function (t) {
          ...
          (b = i.rtlTranslate ? 'right' : i.isHorizontal() ? 'left' : 'top'),
            r
              ? ((y = Math.floor(s / 2) + a + l), (w = Math.floor(s / 2) + a + c))
              : ((y = s + (a - 1) + l), (w = a + c));
          var S = Math.max((x || 0) - w, 0),
            T = Math.min((x || 0) + y, p.length - 1),
            C = (i.slidesGrid[S] || 0) - (i.slidesGrid[0] || 0);
          if (
            (v.extend(i.virtual, { from: S, to: T, offset: C, slidesGrid: i.slidesGrid }),
              u === S && h === T && !t)
          )
            return i.slidesGrid !== f && C !== g && i.slides.css(b, C + 'px'), void i.updateProgress();
          ...
          if (t) i.$wrapperEl.find('.' + i.params.slideClass).remove();
            ...
            for (var M = u; M <= h; M += 1)
              (M < S || M > T) &&
                i.$wrapperEl
                  .find('.' + i.params.slideClass + '[data-swiper-slide-index="' + M + '"]')
                  .remove();
          for (var k = 0; k < p.length; k += 1)
            k >= S && k <= T && (void 0 === h || t ? _.push(k) : (k > h && _.push(k), k < u && E.push(k)));
        ...
        renderSlide: function (t, e) {
          ...
          return (
            s.attr('data-swiper-slide-index') || s.attr('data-swiper-slide-index', e),
      ...
      nt = {
        handle: function (t) {
          ...
          if (
            !this.allowSlideNext &&
            ((this.isHorizontal() && 39 === n) || (this.isVertical() && 40 === n) || 34 === n)
          )
            return !1;
          if (
            !this.allowSlidePrev &&
            ((this.isHorizontal() && 37 === n) || (this.isVertical() && 38 === n) || 33 === n)
          )
            return !1;
          if (
            !(
      ...
      at = {
          ...
          return p.navigator.userAgent.indexOf('firefox') > -1
            ...
            : (function () {
              ...
              return (
                ...
                !0 !== u.implementation.hasFeature('', '') &&
                (t = u.implementation.hasFeature('Events.wheel', '3.0')),
                t
              );
            })()
              ? 'wheel'
        ...
        normalize: function (t) {
          ...
          return (
            ...
            (n || s) &&
            t.deltaMode &&
            (1 === t.deltaMode ? ((n *= 40), (s *= 40)) : ((n *= 800), (s *= 800))),
            n && !e && (e = n < 1 ? -1 : 1),
            s && !i && (i = s < 1 ? -1 : 1),
        ...
        handle: function (t) {
          ...
          var a = n.$el;
          if (
            ('container' !== n.params.mousewheel.eventsTarged && (a = i(n.params.mousewheel.eventsTarged)),
          ...
          if ((s.invert && (r = -r), n.params.freeMode)) {
            ...
            if (
              (x.push(w),
                S
                  ? (w.direction !== S.direction || w.delta > S.delta || w.time > S.time + 150) &&
      ...
      rt = {
        update: function () {
          ...
          if (!this.params.loop) {
            ...
            n &&
              n.length > 0 &&
              (this.isBeginning ? n.addClass(t.disabledClass) : n.removeClass(t.disabledClass),
                n[this.params.watchOverflow && this.isLocked ? 'addClass' : 'removeClass'](t.lockClass)),
              i &&
              i.length > 0 &&
              (this.isEnd ? i.addClass(t.disabledClass) : i.removeClass(t.disabledClass),
        ...
        update: function () {
          ...
          if (e.el && this.pagination.el && this.pagination.$el && 0 !== this.pagination.$el.length) {
            ...
            if (
              (this.params.loop
                ? ((n = Math.ceil(
                  ...
                  s - 1 - 2 * this.loopedSlides && (n -= s - 2 * this.loopedSlides),
                  n > r - 1 && (n -= r),
                ...
                if ((u.addClass(e.bulletActiveClass), e.dynamicBullets)) {
                  ...
                  if (this.params.loop)
                    if (h >= d.length - e.dynamicMainBullets) {
                      ...
                      d
                        .eq(d.length - e.dynamicMainBullets - 1)
                        .addClass(e.bulletActiveClass + '-prev');
                    } else
                      p
                        .prev()
            ...
            'custom' === e.type && e.renderCustom
              ? (a.html(e.renderCustom(this, n + 1, r)), this.emit('paginationRender', this, a[0]))
      ...
      lt = {
        setTranslate: function () {
          if (this.params.scrollbar.el && this.scrollbar.el) {
            var t = this.scrollbar,
              ...
              c = (s - n) * i;
            e
              ? (c = -c) > 0 ? ((l = n - c), (c = 0)) : -c + n > s && (l = s + c)
              : c < 0 ? ((l = n + c), (c = 0)) : c + n > s && (l = s - c),
              this.isHorizontal()
                ? (a.transform('translate3d(' + c + 'px, 0, 0)'), (a[0].style.width = l + 'px'))
                : (a.transform('translate3d(0px, ' + c + 'px, 0)'), (a[0].style.height = l + 'px')),
              o.hide &&
        ...
        init: function () {
          if (this.params.scrollbar.el) {
            ...
            0 === a.length &&
              ((a = i('<div class="' + this.params.scrollbar.dragClass + '"></div>')), s.append(a)),
      ...
      ct = {
        setTransform: function (t, e) {
          ...
          if (
            (o || l
              ? ((o = o || '0'), (l = l || '0'))
              : this.isHorizontal() ? ((o = r), (l = '0')) : ((l = r), (o = '0')),
          ...
          if (!t.enabled) {
            ...
            g.gestures
              ...
              (this.$wrapperEl.on(this.touchEvents.start, n, t.onGestureStart, e),
                ...
                this.$wrapperEl.on(this.touchEvents.cancel, n, t.onGestureEnd, e)),
              this.$wrapperEl.on(
          ...
          if (t.enabled) {
            ...
            g.gestures
              ...
              (this.$wrapperEl.off(this.touchEvents.start, n, t.onGestureStart, e),
                ...
                this.touchEvents.cancel &&
                this.$wrapperEl.off(this.touchEvents.cancel, n, t.onGestureEnd, e)),
              this.$wrapperEl.off(
                this.touchEvents.move,
                '.' + this.params.zoom.containerClass,
                t.onTouchMove,
        ...
        load: function () {
          ...
          if (c.loadPrevNext)
            if (d > 1 || (c.loadPrevNextAmount && c.loadPrevNextAmount > 1)) {
              for (
                var h = c.loadPrevNextAmount,
                p = d,
                f = Math.min(o + p + Math.max(h, p), r.length),
                m = Math.max(o - Math.max(p, h), 0),
                v = o + d;
                v < f;
                v += 1
              )
          ...
          return (
            ...
            (this.interpolate = function (t) {
              return t
                ? ((r = o(this.x, t)),
                  (a = r - 1),
                  (t - this.x[a]) * (this.y[r] - this.y[a]) / (this.x[r] - this.x[a]) + this.y[a])
                : 0;
            }),
            this
          );
        ...
        setTranslate: function (t, e) {
          function i(t) {
            ...
            'slide' === a.params.controller.by &&
              (a.controller.getInterpolateFunction(t), (s = -a.controller.spline.interpolate(-e))),
              (s && 'container' !== a.params.controller.by) ||
              ((n = (t.maxTranslate() - t.minTranslate()) / (a.maxTranslate() - a.minTranslate())),
          ...
          if (Array.isArray(r))
            for (var o = 0; o < r.length; o += 1) r[o] !== e && r[o] instanceof W && i(r[o]);
          ...
          if (this.params.history) {
            ...
            (t.initialized = !0),
              ...
              (t.scrollToSlide(0, t.paths.value, this.params.runCallbacksOnInit),
                ...
                p.addEventListener('popstate', this.history.setHistoryPopState));
          }
        },
        destroy: function () {
          this.params.history.replaceState ||
        ...
        setTranslate: function () {
          ...
          c.shadow &&
            (d
              ? (0 === (t = n.find('.swiper-cube-shadow')).length &&
                ((t = i('<div class="swiper-cube-shadow"></div>')), n.append(t)),
                t.css({ height: a + 'px' }))
              : 0 === (t = e.find('.swiper-cube-shadow')).length &&
              ((t = i('<div class="swiper-cube-shadow"></div>')), e.append(t)));
          for (var p = 0; p < s.length; p += 1) {
            ...
            var S =
              ...
              'px)';
            if (
              (b <= 1 && b > -1 && ((h = 90 * m + 90 * b), o && (h = 90 * -m - 90 * b)),
                f.transform(S),
                c.slideShadows)
            ) {
              ...
              0 === T.length &&
                ((T = i('<div class="swiper-slide-shadow-' + (d ? 'left' : 'top') + '"></div>')),
                  f.append(T)),
                0 === C.length &&
                ((C = i(
        ...
        setTranslate: function () {
          for (var t = this.slides, e = this.rtlTranslate, n = 0; n < t.length; n += 1) {
            ...
            var r = -180 * a,
              ...
              c = 0;
            if (
              (this.isHorizontal() ? e && (r = -r) : ((c = l), (l = 0), (o = -r), (r = 0)),
          ...
          if (e) {
            ...
            if (this.realIndex !== e.realIndex || s) {
              ...
              s && (a += 'next' === r ? n : -1 * n),
                ...
                (e.params.centeredSlides
                  ? (a = a > o ? a - Math.floor(i / 2) + 1 : a + Math.floor(i / 2) - 1)
                  : a > o && (a = a - i + 1),
            ...
            if (
              ...
              for (var h = 0; h < d; h += 1)
                e.$wrapperEl
                  .children('[data-swiper-slide-index="' + (this.realIndex + h) + '"]')
                  .addClass(u);
